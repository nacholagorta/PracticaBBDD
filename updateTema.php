...
if(isset($parameters)){
    ...
    if(JSONCorrectoAnnadir($mensajeRecibido)){
        ...
        //$query  = "UPDATE personas SET CaracteristicaDos =  '" . $Instrumental  . "' WHERE personas.ID = '" . $ID . "'";
        $query = "UPDATE temas SET ID = '" . $ID . "', Nombre = '" .  $Nombre . "', Instrumental = '" . $Instrumental . "', ID_Instrumental = '" . $ID_Instrumental . "'WHERE ID = '" . $ID . "'";
